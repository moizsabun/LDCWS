...
namespace LDCWS.BO
{
   public  class LoadSheddingCompleteList
    {
        public int ArchiveLoadSheddingSNO { get; set; }
        ...
        public string dataAddedByName { get; set; }
        public DateTime? ArchiveAddedDateTime { get; set; }
        public int? ArchiveAddedBy { get; set; }
        public string ArchiveAddedByName { get; set; }
